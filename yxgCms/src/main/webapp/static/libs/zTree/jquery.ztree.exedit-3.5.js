    ...
    //method of operate ztree dom
        _view = {
            ...
            editNode: function(setting, node) {
                ...
                view.cancelCurEditNode(setting);
                view.selectNode(setting, node, false);
                //此处增加了：style='height:100%'
                $$(node, consts.id.SPAN, setting).html("<input type=text class='rename' style='height:100%;padding-top:0px; padding-bottom:0px' id='" + node.tId + consts.id.INPUT + "' treeNode" + consts.id.INPUT + " >");
