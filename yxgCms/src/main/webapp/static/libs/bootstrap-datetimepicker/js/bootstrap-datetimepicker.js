...
!function( $ ) {
	...
	var Datetimepicker = function(element, options) {
		...
		if (this.isRTL){
			...
			this.picker.find('.prev i, .next i')
						.toggleClass('icon-double-angle-left icon-double-angle-right');
		}
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
							'<tr>'+
								'<th class="prev"><i class="icon-double-angle-left"/></th>'+
								'<th colspan="5" class="switch"></th>'+
								'<th class="next"><i class="icon-double-angle-right"/></th>'+
							'</tr>'+
						'</thead>',
