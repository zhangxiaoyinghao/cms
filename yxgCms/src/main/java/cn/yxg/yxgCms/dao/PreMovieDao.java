...
@Repository
public class PreMovieDao extends AdvancedHibernateDao<PreMovie> {
	 ...
	 * @return
	 */
	public List<PreMovie> list(ContentQuery query, Page page) {
		// TODO Auto-generated method stub.
		Criteria criteria = this.getCurrentSession().createCriteria(PreMovie.class,
				"movie");
